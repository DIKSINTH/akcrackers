        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-5">
              <img
                ...
                loading="lazy"
              />
              <h2 className="text-2xl font-bold text-[#f26104]">AK Crackers</h2>
            </div>

            <p className="text-sm leading-relaxed">
              As per 2018 Supreme Court Order, online sale of firecrackers is
              not permitted. Customers can select products on the Estimate Page
              and submit enquiries. Our team will contact you within 2 hours to
              confirm your order.
            </p>

            <p className="text-sm mt-4 leading-relaxed">
              AK Crackers is a licensed and legally compliant fireworks shop in
              Sivakasi, Tamil Nadu, following all explosive safety and statutory
              regulations.
            </p>
          </div>
          ...
          <nav aria-label="Footer Navigation">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link to="/contact" className="hover:text-[#f26104] transition">
                  Contact Us
                </Link>
              </li>
            </ul>
